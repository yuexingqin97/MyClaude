...
### 📖 [修为面板.md](../大衍决残卷/修为面板.md) — 修仙体系实机效果

大衍决自动维护的个人知识统计面板：
- ⚡ **修炼等级**（炼气→渡劫，7 级修仙体系 + 经验值公式）
- 🏆 **成就系统**（6 项自动判定徽章）
- 📊 **技术栈分布** + 技能深度矩阵
- 🏷️ **标签云** + 学习里程碑时间线
- 📈 **累计 Token 统计**（按功能模块分解）
...
```
/myriad-mind ask LearnEcs_v2.md ECS 中 Commands 和 World 的区别是什么？
```

```
/myriad-mind 问 大衍决残卷/Bevy学习笔记/LearnEcs.md 什么是QueryFilter？
```

> 读取已有笔记内容，回答用户提问，**问答记录自动追加回原文档末尾**，形成可追溯的学习对话。
